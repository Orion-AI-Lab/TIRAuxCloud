...
class BAM_CD(BaseModel, torch.nn.Module):
    ...
    def __init__(
        ...
        decoder_attention_type: Optional[str] = None, # For adding Attention squeeze and exitation "scse"
        in_channels: int = 3,
        classes: int = 2,
        fusion_mode: str = 'conc', #'diff' concatenation or difference
        activation: Optional[Union[str, callable]] = None,
        siamese: bool = True, #False
